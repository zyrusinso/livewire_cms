<div class="p-6">
    <div class="flex items-center justify-end px-4 py-3 text-right sm:px-6">
        ...
        <x-jet-button class="ml-5" wire:click="createShowModal">
            {{ __('Create') }}
        </x-jet-button>
    </div>
                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        <td class="px-6 py-4 text-sm whitespace-no-wrap">
                                            ...
                                            {!! $item->is_default_not_found ? '<span class="text-red-400 text-xs font-bold" style="color: red">[Default 404 Page]</span>':''!!}
                                        </td>
                                        <td class="px-6 py-4 text-sm whitespace-no-wrap">
                                            <a
